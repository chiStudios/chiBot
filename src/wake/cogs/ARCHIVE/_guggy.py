...
class guggy(commands.Cog):
    ...
    async def _clean(self, channel, seconds = 600, limit = 1000, delete_before = True):
        ...
        time_channel = self.bot.get_channel(1224371034908655700) # usagi_has_a_gun/bot-spam
    ...
    async def clean_timer(self):
        await self._clean(self.bot.get_channel(1208144053045166100), 1800, 1000) # usagi_has_a_gun/bot
        await self._clean(self.bot.get_channel(1222328766932455466), 21600, 1000) # Refined RP LOCKED/radio-transmissions
    ...
    async def on_message(self, message):
        ...
        yikes = self.bot.get_channel(1224371034908655700) # message deletion log channel
