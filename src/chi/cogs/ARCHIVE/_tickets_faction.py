...
class MakeAFactionTicket(discord.ui.View):
    ...
    async def button_callback(self, button, interaction):
        ...
        faction = await interaction.guild.fetch_channel(self.server_settings.mod_channel['faction_ticket'])
        ...
        faction_embed = discord.Embed(
                                      title=self.name.title(), description=
                                      'For all members in  your faction, please list their discord usernames '
        ...
        faction_embed.set_footer(text='Please bare with us as we set up your faction role.')
