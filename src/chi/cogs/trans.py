...
def word_is_in_blacklist(message):
    ...
    print("message not in blacklist...")
...
class trans_auto(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.REACTION_EMOJI = "<:translate:1241010530664185887>"
        self.EMOJI_ARROW = "<:translated_to:1241010219492966522>"
    ...
    def parse_pronunciation(self, message, translation):
        ...
        print(f"pronunciation before parse: {pronunciation_list}")  # info print
    ...
    def detect_lang(self, message):
        ...
        print(f"detected = {detected}")  # info print
    ...
    def should_translate(self, message, lang, confidence):
        ...
        if word_is_in_blacklist(message):
            print("word is in blacklist, aborting translation...")
            return False
    ...
    def should_add_reaction(self, message, translation):
        ...
        if translation.text == message.content:
            print("translation == message, aborting translation...")  # info print
            return False
        ...
        if similarity > self.SIMILARITY_THRESHOLD:
            print(f"similarity > THRESHOLD, aborting translation... ({similarity})")
            return False  # guard clause
